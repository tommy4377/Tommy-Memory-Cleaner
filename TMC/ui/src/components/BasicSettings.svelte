...
<div class="group">
  ...
  <div class="row">
    <label>
      <input
        ...
        on:change={() => toggle('always_on_top')}
      />
      {$t('Always on top')}
    </label>
  </div>
  ...
  <div class="row">
    <label>
      <input
        type="checkbox"
        checked={cfg?.close_after_opt}
        on:change={() => toggle('close_after_opt')}
      />
  ...
  <div class="row">
    <label>
      <input
        ...
        on:change={() => toggle('minimize_to_tray')}
      />
  ...
  <div class="row">
    <label>
      <input
        type="checkbox"
        checked={cfg?.show_opt_notifications}
        on:change={() => toggle('show_opt_notifications')}
      />
