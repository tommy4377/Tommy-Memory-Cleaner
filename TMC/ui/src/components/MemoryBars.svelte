...
<div class="card">
  <div class="row">
    ...
    <div class="val">
      {mem
        ? `${mem.physical.used.value.toFixed(1)} ${mem.physical.used.unit} (${mem.physical.used.percentage}%)`
        : '--'}
    </div>
  </div>
  <div class="row">
    ...
    <div class="val">
      {mem
        ? `${mem.physical.free.value.toFixed(1)} ${mem.physical.free.unit} (${mem.physical.free.percentage}%)`
        : '--'}
    </div>
  </div>
</div>
