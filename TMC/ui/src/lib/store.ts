  ...
  try {
    ...
    if (cfg) {
      ...
      if (theme === 'light') {
        ...
        } else if (cfg.main_color_hex && cfg.main_color_hex !== '#0a84ff' && cfg.main_color_hex !== '#007aff') {
        ...
        } else if (cfg.main_color_hex && cfg.main_color_hex !== '#9a8a72' && cfg.main_color_hex !== '#007aff') {
  ...
  try {
    ...
    if (partial.theme !== undefined) {
      ...
      if (newTheme === 'light') {
        ...
        } else if (currentConfig.main_color_hex && currentConfig.main_color_hex !== '#0a84ff' && currentConfig.main_color_hex !== '#007aff') {
        ...
        } else if (currentConfig.main_color_hex && currentConfig.main_color_hex !== '#9a8a72' && currentConfig.main_color_hex !== '#007aff') {
          mainColor = currentConfig.main_color_hex;
        } else {
          mainColor = '#0a84ff';
        }
    ...
    if (partial.main_color_hex_light !== undefined || partial.main_color_hex_dark !== undefined) {
      const mainColor = currentTheme === 'light'
        ? (partial.main_color_hex_light || currentConfig.main_color_hex_light || currentConfig.main_color_hex || '#9a8a72')
        : (partial.main_color_hex_dark || currentConfig.main_color_hex_dark || currentConfig.main_color_hex || '#0a84ff');
