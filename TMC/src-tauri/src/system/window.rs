...
pub fn set_rounded_corners(hwnd: windows_sys::Win32::Foundation::HWND) -> Result<(), String> {
    ...
    unsafe {
        ...
        if is_win11 {
            ...
            tracing::info!("Windows 11 detected - enabling DWM rounded corners");
            ...
            // Windows 10: CSS-only rounded corners
            tracing::info!("Windows 10 detected - using CSS-only rounded corners");
        }
